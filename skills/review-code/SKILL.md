---
name: review-code
description: "Full code review pipeline: launches `/code-review`, `/security-review`, and `/peer-review` in parallel, evaluates findings, and returns actionable results. Use when the user asks to \"review my code\", \"full code review\", \"review my changes\", or wants a comprehensive code review."
---
...
Launch all three reviews in a single message so they run concurrently. The diff command from Step 1 determines what each reviewer analyzes.
